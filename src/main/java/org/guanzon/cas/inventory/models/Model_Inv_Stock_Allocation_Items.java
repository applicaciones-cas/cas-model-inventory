 ...
 * @author Unclejo
 */
public class Model_Inv_Stock_Allocation_Items implements GEntity{
    final String XML = "Model_Inv_Stock_Allocation_Items.xml";
     ...
     */
    public Model_Inv_Stock_Allocation_Items(GRider foValue){
        if (foValue == null){
    ...
    public String getTable() {
        return "Inv_Stock_Allocation_Items";
    }
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE){
            ...
            if (pnEditMode == EditMode.ADDNEW){
                ...
                Model_Inv_Stock_Allocation_Items loOldEntity = new Model_Inv_Stock_Allocation_Items(poGRider);
    ...
    public String getOrderNumber(){
     ...
     /**
     * Sets the Transaction date of this record.
     * 
     * @param fdValue 
     * @return result as success/failed
     */
    ...
    /**
     * @return The Transaction date of this record. 
     */
    public Date getTransactionDate(){
        return (Date) getValue("dTransact");
    }
     /**
     * Sets the sPartsIDx of this record.
     * 
     * @param fsValue 
     * @return result as success/failed
     */
    public JSONObject setPartsID(String fsValue){
        return setValue("sPartsIDx", fsValue);
    }
    
    /**
     * @return The sPartsIDx of this record. 
     */
    ...
    /**
     * Sets the nQtyOrder of this record.
     * 
     * @param fnValue 
     * @return result as success/failed
     */
    public JSONObject setQuantityOrder(int fnValue){
        return setValue("nQtyOrder", fnValue);
    }
    
    /**
     * @return The nQtyOrder of this record. 
     */
    ...
    /**
     * Sets the nQtyIssue of this record.
     * 
     * @param fnValue 
     * @return result as success/failed
     */
    public JSONObject setQuantityIssue(int fnValue){
        return setValue("nQtyIssue", fnValue);
    }
    
    /**
     * @return The nQtyIssue of this record. 
     */
    ...
    private void initialize(){
        try {
            ...
            poEntity.updateString("sStockIDx", "");
            poEntity.updateString("sReplacID", "");
