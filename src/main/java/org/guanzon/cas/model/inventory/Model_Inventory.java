...
public class Model_Inventory implements GEntity{
    ...
    public JSONObject openRecord(String fsCondition) {
        ...
        String lsSQL = MiscUtil.makeSelect(this, "xCategNm1»xCategNm2»xCategNm3»xCategNm4»xBrandNme»xModelNme»xModelDsc»xColorNme»xMeasurNm»xInvTypNm»xSuperCde»xSuperDsc");
