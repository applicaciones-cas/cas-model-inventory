 ...
 * @author Maynard
 */
public class PurchaseOrder_InventoryStockRequest implements GTranDet {
    ...
    public PurchaseOrder_InventoryStockRequest(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
...
//            }
    ...
    public JSONObject searchTransaction(String fsColumn, String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModelMaster.makeSQL(), " sTransNox LIKE "
