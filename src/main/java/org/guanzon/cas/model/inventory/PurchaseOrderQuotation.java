 ...
 * @author Maynard
 */
public class PurchaseOrderQuotation implements GTranDet {
    ...
    Model_PO_Quotation_Master poModelMaster;
    ArrayList<Model_PO_Quotation_Detail> poModelDetail;

    JSONObject poJSON;

    public PurchaseOrderQuotation(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModelMaster = new Model_PO_Quotation_Master(foGRider);
        poModelDetail = new ArrayList<Model_PO_Quotation_Detail>();
        poModelDetail.add(new Model_PO_Quotation_Detail(foGRider));
...
//            }
    ...
    @Override
    public ArrayList<Model_PO_Quotation_Detail> getDetailModel() {
    ...
    @Override
    public Model_PO_Quotation_Master getMasterModel() {
    ...
    public JSONObject OpenModelDetail(String fsTransNo) {
        ...
        try {
            ...
            while (loRS.next()) {
                ...
                poModelDetail.add(new Model_PO_Quotation_Detail(poGRider));
